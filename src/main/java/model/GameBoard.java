...
public class GameBoard {
    ...
    private void setBoard(PropertyController propertyController, ChanceCardController cardController) {
        ...
        squareList[2] = new ChanceSquare("Prøv lykken", 0, cardController);
        squareList[3] = new StreetSquare("Hvidovrevej", new int[]{4, 20, 60, 180, 320, 540}, 60, 0, 3, 2, propertyController);
        squareList[4] = new Tax("Indkomstskat", 200, 10, propertyController);
        squareList[5] = new TravelSquare("Øresund",  new int []{25, 50, 100, 200},200, propertyController);
        squareList[6] = new StreetSquare("Roskildevej", new int[]{6, 30, 90, 270, 400, 550}, 100, 1, 6, 3, propertyController);
        squareList[7] = new ChanceSquare("Prøv lykken", 1, cardController);
        ...
        squareList[15] = new TravelSquare("D.F.D.S", new int []{25, 50, 100, 200},200, propertyController);
        squareList[16] = new StreetSquare("Bernstoffsvej", new int[]{14, 70, 200, 550, 750, 950}, 180, 3, 16, 3, propertyController);
        squareList[17] = new ChanceSquare("Prøv lykken", 2, cardController);
        ...
        squareList[20] = new Parking("'Helle'", propertyController);
        squareList[21] = new StreetSquare("Trianglen", new int[]{18, 90, 250, 700, 875, 1050}, 220, 4, 21, 3, propertyController);
        squareList[22] = new ChanceSquare("Prøv lykken", 3, cardController);
        ...
        squareList[25] = new TravelSquare("Ø.K.", new int []{25, 50, 100, 200},200,propertyController );
        ...
        squareList[28] = new Company("Carlsberg", 150, propertyController);
        squareList[29] = new StreetSquare("Østergade", new int[]{22, 120, 360, 850, 1025, 1200}, 280, 5, 29, 3, propertyController);
        squareList[30] = new Jail("De fængsles",propertyController);
        ...
        squareList[33] = new ChanceSquare("Prøv lykken", 4, cardController);
        squareList[34] = new StreetSquare("Nygade", new int[]{28, 150, 450, 1000, 1200, 1400}, 320, 6, 34, 3, propertyController);
        squareList[35] = new TravelSquare("D/S Bornholm 1866", new int []{25, 50, 100, 200},200,propertyController);
        squareList[36] = new ChanceSquare("Prøv lykken", 5, cardController);
        squareList[37] = new StreetSquare("Frederiksberggade", new int[]{35, 175, 500, 1100, 1300, 1500}, 350, 7, 37, 1, propertyController);
        squareList[38] = new Tax("Statsskat", 100, 0, propertyController);
